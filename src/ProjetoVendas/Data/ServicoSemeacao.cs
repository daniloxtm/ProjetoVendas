...
{
    public class ServicoSemeacao
    {
        private ProjetoVendasContext _context;

        public ServicoSemeacao(ProjetoVendasContext context)
        {
            _context = context;
        }
        ...
        public void Semente()
        {
            ...
            RegistroVendas r1 = new RegistroVendas(1, new DateTime(2018, 09, 25), 11000.0, StatusVendas.Faturado, s1);
            RegistroVendas r2 = new RegistroVendas(2, new DateTime(2018, 09, 4), 7000.0, StatusVendas.Faturado, s5);
